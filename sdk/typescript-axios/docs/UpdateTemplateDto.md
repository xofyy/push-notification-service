...
**title** | **string** | Notification title template | [optional] [default to undefined]
**body** | **string** | Notification body template | [optional] [default to undefined]
...
**updatedBy** | **string** | Updated by user ID | [optional] [default to undefined]

## Example

```typescript
import { UpdateTemplateDto } from './api';

const instance: UpdateTemplateDto = {
    name,
    description,
    title,
    body,
