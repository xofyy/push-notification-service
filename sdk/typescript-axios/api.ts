...
export const WebhooksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        webhooksAdd: async (projectId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'projectId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        webhooksUpdate: async (projectId: string, index: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'projectId' is not null or undefined
...
export const WebhooksApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async webhooksAdd(projectId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.webhooksAdd(projectId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async webhooksUpdate(projectId: string, index: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.webhooksUpdate(projectId, index, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const WebhooksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        webhooksAdd(projectId: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.webhooksAdd(projectId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary List project webhooks
         ...
         * @throws {RequiredError}
         */
        webhooksUpdate(projectId: string, index: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.webhooksUpdate(projectId, index, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class WebhooksApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public webhooksAdd(projectId: string, options?: RawAxiosRequestConfig) {
        return WebhooksApiFp(this.configuration).webhooksAdd(projectId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public webhooksUpdate(projectId: string, index: string, options?: RawAxiosRequestConfig) {
        return WebhooksApiFp(this.configuration).webhooksUpdate(projectId, index, options).then((request) => request(this.axios, this.basePath));
    }
}
