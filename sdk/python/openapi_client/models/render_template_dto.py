...
class RenderTemplateDto(BaseModel):
    ...
    RenderTemplateDto
    """ # noqa: E501
    template: StrictStr = Field(description="Template ID or name to render")
    variables: Dict[str, Any] = Field(description="Variables to substitute in template")
    preview: Optional[StrictBool] = Field(default=None, description="Preview mode - do not save statistics")
    __properties: ClassVar[List[str]] = ["template", "variables", "preview"]
